...
function ucitajStrategije() {
    var sveIgre = dohvatiIgre();

    strategije = sveIgre.filter(igra => igra.kategorija === "Strategije");

    prikaziStrategije(strategije);
}

function prikaziStrategije(igre) {
...
function filtrirajISortiraj() {
    ...
    var rezultat = strategije.filter(igra => {
