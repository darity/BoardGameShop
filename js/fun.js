...
$(document).ready(function(){
    ...
    document.title = translations[currentLanguage].fun.title;
...
function ucitajZabavne() {
    var sveIgre = dohvatiIgre();

    zabavne = sveIgre.filter(igra => igra.kategorija === "Zabavne");

    prikaziZabavne(zabavne);
}

function prikaziZabavne(igre) {
...
function filtrirajISortiraj() {
    ...
    var rezultat = zabavne.filter(igra => {
...
function generisiPDF(igre) {
    ...
    pdf.text("Katalog zabavnih igara", 20, y);
    ...
    pdf.save("katalog-zabavne-igre.pdf");
}
